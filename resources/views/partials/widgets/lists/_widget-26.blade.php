...
<!--end::LIst widget 26--> --}}
<div class="card card-flush h-lg-40 d-flex justify-content-center align-items-center mb-8">
<div class="ps-lg-6  mt-md-0 d-flex justify-content-center align-items-center h-100">
    <!--begin::Body-->
    <div class="mb-10 mt-10">
        ...
        <div class="d-flex flex-stack flex-wrap">
            ...
            <div class="d-flex align-items-center pe-2">
                ...
                <div class="symbol symbol-35px symbol-circle me-3">
                    <img src="image.png" class="" alt="">
                </div>
                <!--end::Avatar-->

                <!--begin::Text-->
                {{-- <div class="fs-5 fw-bold">
                    <a href="/metronic8/demo1/pages/user-profile/overview.html" class="text-gray-700 text-hover-primary">Jane Miller</a>
        ...
        <!--end::Footer-->
        <!--begin::Title-->
        <p class="fw-bold text-gray-900 mb-1 fs-2 lh-base ">
            Selamat Datang, Budi!</p>
        <p class=" text-gray-900 mb-4 fs-5 lh-base ">
            Sebagai Resepsionis </p>

        <!--end::Title-->

        <!--begin::Text-->
        <div class="fw-semibold fs-5 mt-4 text-gray-600 text-gray-900">
            Pantau kesehatan pasien hewan, kelola jadwal perawatan, dan akses rekam medis dengan mudah di sistem manajemen klinik hewan Anda.
        </div>
    </div>
        <!--end::Text-->
    </div>
